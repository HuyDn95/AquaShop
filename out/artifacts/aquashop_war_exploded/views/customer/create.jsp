        ...
        <div class="col-lg-10">
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                ...
                <div class="card-body p-5 bg-white">
                    ...
                    <form action="customer?action=insert" method="post" class="needs-validation" novalidate>
                        <div class="row g-4">
                            <!-- Section: Tài khoản -->
                            <div class="col-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg bg-light border-0 py-3 shadow-none" 
                                           id="username" name="username" value="${cust.username}" placeholder="Nhập tên đăng nhập" required
                            ...
                            <div class="col-md-6">
                                <label for="password" class="form-label fw-semibold text-secondary small mb-2">Mật khẩu <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light border-0"><i class="fas fa-lock text-muted"></i></span>
                                    <input type="password" class="form-control form-control-lg bg-light border-0 py-3 shadow-none" 
                                           id="password" name="password" value="${cust.password}" placeholder="Nhập mật khẩu" required
                                           style="border-top-right-radius: 12px; border-bottom-right-radius: 12px;">
                                    <div class="invalid-feedback ps-2">Vui lòng nhập mật khẩu</div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg bg-light border-0 py-3 shadow-none" 
                                           id="fullName" name="fullName" value="${cust.fullName}" placeholder="Nhập họ và tên đầy đủ" required
                                           style="border-top-right-radius: 12px; border-bottom-right-radius: 12px;">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control form-control-lg bg-light border-0 py-3 shadow-none" 
                                           id="email" name="email" value="${cust.email}" placeholder="example@mail.com"
                                           style="border-top-right-radius: 12px; border-bottom-right-radius: 12px;">
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg bg-light border-0 py-3 shadow-none" 
                                           id="phone" name="phone" value="${cust.phone}" placeholder="Nhập số điện thoại"
                                           style="border-top-right-radius: 12px; border-bottom-right-radius: 12px;">
                                </div>
                            </div>
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg bg-light border-0 py-3 shadow-none" 
                                           id="address" name="address" value="${cust.address}" placeholder="Số nhà, tên đường, phường/xã, quận/huyện..."
                                           style="border-top-right-radius: 12px; border-bottom-right-radius: 12px;">
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select form-select-lg bg-light border-0 py-3 shadow-none" 
                                        ...
                                        <option value="admin" ${cust.role == 'admin' ? 'selected' : ''}>Quản trị viên (Admin)</option>
                                    </select>
                                </div>
                            </div>
