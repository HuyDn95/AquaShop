...
<div class="container-fluid py-4">
    <div class="row mb-4 align-items-center">
        ...
        <div class="col-md-6 text-md-end mt-3 mt-md-0">
            <a href="${pageContext.request.contextPath}/orders?action=add" class="btn btn-primary rounded-pill px-4 shadow-sm">
                            ...
                            <tr>
                                <td colspan="5" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <p class="text-muted small">Các đơn hàng mới sẽ xuất hiện tại đây.</p>
                                        <a href="${pageContext.request.contextPath}/orders?action=add" class="btn btn-primary btn-sm rounded-pill px-4">
