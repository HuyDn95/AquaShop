...
<%--        </li>--%>
        <li class="nav-item">
            <a href="${pageContext.request.contextPath}/products" class="nav-link ${title == 'Sản phẩm' || title == 'Danh sách sản phẩm' || title == 'Thêm sản phẩm mới' || title == 'Chỉnh sửa sản phẩm' ? 'active' : ''}">
                <i class="fas fa-box-open me-3" style="width: 20px;"></i>
                <span>Sản phẩm</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="${pageContext.request.contextPath}/customer" class="nav-link ${title == 'Khách hàng' || title == 'Danh sách khách hàng' || title == 'Thêm khách hàng mới' || title == 'Chỉnh sửa thông tin khách hàng' ? 'active' : ''}">
                <i class="fas fa-user-friends me-3" style="width: 20px;"></i>
                <span>Khách hàng</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="${pageContext.request.contextPath}/orders" class="nav-link ${title == 'Đơn hàng' || title == 'Danh sách đơn hàng' || title == 'Chi tiết đơn hàng' ? 'active' : ''}">
                <i class="fas fa-shopping-bag me-3" style="width: 20px;"></i>
                <span>Đơn hàng</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="${pageContext.request.contextPath}/category" class="nav-link ${title == 'Danh mục' || title == 'Danh sách danh mục' || title == 'Thêm danh mục' || title == 'Sửa danh mục' ? 'active' : ''}">
