        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm rounded-3">
                <div class="card-header bg-white border-0 py-3">
                    <h3 class="fw-bold text-primary mb-0"><i class="fas fa-edit me-2"></i>Chỉnh sửa sản phẩm</h3>
                </div>
                    ...
                    <form action="product-edit" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <c:if test="${not empty product.image}">
                                <div class="mt-2">
                                    <p class="mb-1 text-muted small">Xem trước:</p>
                                    <img src="${product.image}" alt="Preview" class="rounded border" style="max-height: 100px;">
                                </div>
                            </c:if>
                        </div>
                        <div class="mb-4">
