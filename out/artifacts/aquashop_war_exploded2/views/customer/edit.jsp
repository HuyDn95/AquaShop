...
<jsp:include page="/views/layout/header.jsp">
    <jsp:param name="title" value="Chỉnh sửa thông tin khách hàng" />
</jsp:include>
        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm rounded-3">
                <div class="card-header bg-white py-3 border-0">
                    <h3 class="fw-bold text-primary mb-0"><i class="fas fa-user-edit me-2"></i>Chỉnh sửa thông tin khách hàng</h3>
                </div>
